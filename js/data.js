...
const projects = [
    ...
    { id: 5, title: "Multi-Specialty Hospital Record Room", category: "Healthcare", desc: "Secure patient records storage for a hospital chain", scale: "20,000 sq ft", img: "project_corporate.png", details: "Installed steel compactors with restricted access, meeting healthcare guidelines. Patient file retrieval time reduced from 12 minutes to 3 minutes." },
...
const faqs = [
    ...
    { q: "How much floor space can Space Planners' storage systems save?", a: "Space Planners' storage systems save an average of 60–70% of floor space compared to conventional static storage, based on data from over 2,000 installations. Mobile compactor systems specifically can save 60–70% of floor space by eliminating redundant access aisles." },
